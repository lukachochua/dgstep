...
class ServiceResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Service Entries';
    protected static ?string $modelLabel = 'Service Entry';
    protected static ?string $pluralModelLabel = 'Service Entries';
