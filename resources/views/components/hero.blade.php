<section
    ...
    <div class="max-w-7xl mx-auto px-6 sm:px-8 py-24 md:py-32 flex flex-col md:flex-row items-center gap-12">
        ...
        <div class="max-w-xl text-center md:text-left">
            ...
            <p class="mt-6 text-lg md:text-xl max-w-md drop-shadow-md">
                DGstep accelerates your project with blazing fast setup, intuitive UI, and modern Laravel + Tailwind
                stack.
            </p>
            <div class="mt-8 flex justify-center md:justify-start gap-4">
                <a href="#features"
                    class="inline-block bg-white text-[var(--color-electric-sky)] font-semibold px-6 py-3 rounded-lg shadow-lg hover:bg-gray-100 transition">
                    Explore Features
                </a>
                <a href="#contact"
