...
<!-- Mobile Menu -->
<div id="mobile-menu"
    class="hidden lg:hidden container mx-auto px-4 sm:px-6 md:px-8 pb-6 pt-4 space-y-5 text-center text-base font-medium text-white font-[FiraGO] bg-[rgb(15,25,50)] border-t border-white/10 shadow-md z-40">
